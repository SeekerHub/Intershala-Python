...
"color: rgb(238, 238, 236);")
    ...
    def retranslateUi(self, Evaluate):
        ...
        self.cb_1.setItemText(2, _translate("Evaluate", "Rnagers"))
        ...
        # item.setText(_translate("Evaluate", "ddandkndjnadnkan"))
        ...
        # item.setText(_translate("Evaluate", "New Item"))
        # item = self.list_2.item(3)
        # item.setText(_translate("Evaluate", "New Item"))
        # item = self.list_2.item(4)
        # item.setText(_translate("Evaluate", "New Item"))
